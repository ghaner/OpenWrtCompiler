...
#===========================================================================================================
# add a third-party feed:git clone feed-url package/每个feed须单独一个文件夹 tpf-feed用户名-仓库名
...
git clone https://github.com/ghaner/OpenWrtPackage package/tpf-ghaner-OpenWrtPackage
git clone https://github.com/kenzok8/openwrt-packages package/tpf-kenzok8-openwrt-packages
git clone https://github.com/kenzok8/small package/tpf-kenzok8-small
