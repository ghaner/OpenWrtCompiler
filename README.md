...
1.2 20220220 根据https://github.com/281677160/common/blob/main/common.sh 对比修改后目前Compilation Information step不再自动中断 ,但是编译信息显示不全{缺固件内核),此信息可能被GitHub官方屏蔽,保持此文件暂时不再考虑改变,除非再导致编译自动中断.
